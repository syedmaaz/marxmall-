                ...
                <ul>
                    <li data-transition="3dcurtain-vertical" data-slotamount="7" data-masterspeed="500"> <img src="<?php echo Yii::getAlias('@web') ?>/images/slide4.jpg" alt="slidebg1" data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat" />
                        ...
                        <div class="tp-caption skewfromright" data-x="670" data-y="290" data-speed="2000" data-start="800" data-easing="Back.easeOut" data-endspeed="500" data-captionhidden="on" style="z-index:8;">
                            <p class="slide4-text3">Sed eget tellus sapien. Proinupmoso etiamgo velmis dolor amet pPro-
                                <br /> inupmoso etiamgo velmis dolor amet promo elit.</p>
                        </div>
                    </li>
                    <!-- SLIDE 1  -->
                            ...
                            <?php foreach ($products as $key => $prod): ?>
                                <div class="cat1 cat3 col-lg-3  col-md-6 col-sm-12 inner-products ">
                                    <div class="best-seller most-sold">
                                        ...
                                        <div class="best-seller seller2 sold-thumb">
                                            <a class="best-seller seller2 sold-thumb animated flipInY" href="<?= Yii::$app->urlManager->createUrl(['home/detail', 'id' => $prod->prod_id]) ?>">
...
<div class="container  header-background">
    ...
    <div class="container"> <span><i>OUR</i> BRANDS</span>
      <div class="brands"> <a href="#" title=""><img src="<?php echo Yii::getAlias('@web') ?>/images/brand1.png" alt="" /></a> <a href="#" title=""><img src="<?php echo Yii::getAlias('@web') ?>/images/brand2.png" alt="" /></a> <a href="#" title=""><img src="<?php echo Yii::getAlias('@web') ?>/images/brand3.png" alt="" /></a> <a href="#" title=""><img src="<?php echo Yii::getAlias('@web') ?>/images/brand4.png" alt="" /></a> <a href="#" title=""><img src="<?php echo Yii::getAlias('@web') ?>/images/brand2.png" alt="" /></a> <a href="#" title=""><img src="<?php echo Yii::getAlias('@web') ?>/images/brand4.png" alt="" /></a> <a href="#" title=""><img src="<?php echo Yii::getAlias('@web') ?>/images/brand2.png" alt="" /></a> <a href="#" title=""><img src="<?php echo Yii::getAlias('@web') ?>/images/brand1.png" alt="" /></a> <a href="#" title=""><img src="<?php echo Yii::getAlias('@web') ?>/images/brand3.png" alt="" /></a> <a href="#" title=""><img src="images/brand4.png" alt="" /></a> </div>
    </div>
  </section>
